...
train_data_file = open('D:/Active/Coding File 4/project-122/PRO-C122-Project-Boilerplate-main/PRO-C122-Project-Boilerplate-main/static/assets/chatbot_corpus/intents.json').read()
